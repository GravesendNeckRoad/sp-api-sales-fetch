...
class GenerateFBAReport:       
    ...
    def get_download_url(self, report_id: Optional[str] = None) -> Tuple[str, str]:
        ...
        Parameters:
            ...
            Otherwise, returns download_url and compression BUT updates the instance attributes, so that 
            you can use download_report immediately after without passing any params
